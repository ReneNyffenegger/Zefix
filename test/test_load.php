...
function check_person_firma($dbh) { #_{
  ...
  check_count($dbh, 'person_firma', 249);
  ...
  $cnt=1;
    ...
    cmp_person_firma($sth,  $cnt++,  601009   , '2001-01-25'  , '+'  , 'Feurer'           , 'Rudolf'           , 'Schaffhausen'                        , NULL                                        , 'Taichung'                  ,  $gs_gf                                      ,   $eu                                                  ,  'mit einer Stammeinlage von CHF 10\'000.--'            );

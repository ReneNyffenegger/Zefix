...
function check_person_firma($dbh) { #_{
  ...
  cmp_person_firma($sth, $cnt++, 451407   ,'2008-09-08'  ,'-'  ,'Nyffenegger'   ,'René'             ,'Eriswil'                             ,NULL                                        ,'Zürich'                    ,$gs_gf                                       , 'mit Kollektivunterschrift zu zweien'                 , 'mit einem Stammanteil von CHF 10\'000.00'             );
  ...
  cmp_person_firma($sth, $cnt++, 934296   ,'2009-11-06'  ,'+'  ,'Kuhn'          ,'Roland'           ,'Illnau-Effretikon'                   ,NULL                                        ,'St. Gallen'                ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  cmp_person_firma($sth, $cnt++, 934296   ,'2009-11-06'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                        ,'Freienbach'                ,$gl_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  cmp_person_firma($sth, $cnt++, 934296   ,'2009-11-06'  ,'+'  ,'Keller'        ,'Primin'           ,'Altendorf'                           ,NULL                                        ,'Waldkirch'                 ,$gl_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 823465   ,'2011-10-27'  ,'+'  ,'Hagger'        ,'Joachim Andreas'  ,'Basel'                               ,NULL                                        ,'Zürich'                    ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  cmp_person_firma($sth, $cnt++, 823465   ,'2011-10-27'  ,'+'  ,'Vckovski'      ,'Andrej'           ,'Zürich'                              ,NULL                                        ,'Zürich'                    ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 823465   ,'2014-08-13'  ,'-'  ,'Hagger'        ,'Joachim Andreas'  ,'Basel'                               ,NULL                                        ,'Zürich'                    ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  cmp_person_firma($sth, $cnt++, 823465   ,'2014-08-13'  ,'+'  ,'Franz'         ,'Mike'             ,'Frick'                               ,NULL                                        ,'Gipf-Oberfrick'            ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 934296   ,'2016-12-15'  ,'-'  ,'Kuhn'          ,'Roland'           ,'Illnau-Effretikon'                   ,NULL                                        ,'St. Gallen'                ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  cmp_person_firma($sth, $cnt++, 934296   ,'2016-12-15'  ,'-'  ,'Keller'        ,'Primin'           ,'Altendorf'                           ,NULL                                        ,'Waldkirch'                 ,$gl_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  cmp_person_firma($sth, $cnt++, 934296   ,'2016-12-15'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                        ,'Freienbach'                ,$vr_mg                                       , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 1290391  ,'2017-01-10'  ,'+'  ,'Oesch'         ,'Severin'          ,'Embrach'                             ,NULL                                        ,'Kloten'                    ,$gs_gf                                       , 'mit Kollektivunterschrift zu zweien'                 , 'mit 10 Stammanteilen zu je CHF 1\'000.00'             );

...
function check_person_firma($dbh) { #_{
  ...
  check_count($dbh, 'person_firma', 59);
  $sth = db_prep_exec($dbh, 'select * from person_firma order by dt_journal, id_firma');

  cmp_person_firma($sth, 251792   ,'2001-07-30'  ,'-'  ,'Dettwiler'     ,'Werner'           ,'Reigoldswil'                         ,NULL                                               ,'Eichberg'                  ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              ,  NULL                                                  , 0  ,0  ,0); #_{
  cmp_person_firma($sth, 251792   ,'2001-07-30'  ,'+'  ,'Wüst'          ,'Günter'           ,'Oberriet SG'                         ,NULL                                               ,'Lüchingen (Altstätten)'    ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              ,  NULL                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2005-07-04'  ,'-'  ,NULL            ,NULL               ,NULL                                  ,'Künzler Communications GmbH'                      ,'Bassersdorf'               , null                                        , 'ohne Zeichnungsberechtigung'                         , 'mit einer Stammeinlage von CHF 1\'000.--'             , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2005-07-04'  ,'+'  ,'Nyffenegger'   ,'René'             ,'Eriswil'                             ,NULL                                               ,'Zürich'                    ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              , 'mit einer Stammeinlage von CHF 20\'000.--'            , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2005-12-22'  ,'+'  ,'Rossbacher'    ,'Albert'           ,'Röthenbach bei Herzogenbuchsee'      ,NULL                                               ,'Herrliberg'                ,'Mitglied'                                   , 'mit Einzelunterschrift'                              ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2005-12-22'  ,'+'  ,NULL            ,NULL               ,NULL                                  ,'Ortag, Organisations-, Revisions- und Treuhand-AG','Zürich'                    , null                                        ,  null                                                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2006-05-16'  ,'-'  ,'Rossbacher'    ,'Albert'           ,'Röthenbach bei Herzogenbuchsee'      ,NULL                                               ,'Herrliberg'                ,'Mitglied'                                   , 'mit Einzelunterschrift'                              ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2006-05-16'  ,'+'  ,'Hagger'        ,'Joachim Andreas'  ,'Basel'                               ,NULL                                               ,'Zürich'                    ,'Präsident'                                  , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2006-05-16'  ,'+'  ,'Gränicher'     ,'Hans Peter'       ,'Röthenbach bei Herzogenbuchsee'      ,NULL                                               ,'Zürich'                    ,'Mitglied'                                   , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2006-05-16'  ,'+'  ,'Hefti'         ,'Simon'            ,'Thun'                                ,NULL                                               ,'Zürich'                    ,'Mitglied'                                   , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2007-05-07'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Rüschlikon'                ,'Gesellschafter und Geschäftsführer'         , 'mit Kollektivunterschrift zu zweien'                 , 'mit einer Stammeinlage von CHF 10\'000.--'            , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2007-05-07'  ,'+'  ,'Nyffenegger'   ,'René'             ,'Eriswil'                             ,NULL                                               ,'Zürich'                    ,'Gesellschafter und Geschäftsführer'         , 'mit Kollektivunterschrift zu zweien'                 , 'mit einer Stammeinlage von CHF 10\'000.--'            , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2008-09-08'  ,'-'  ,'Nyffenegger'   ,'René'             ,'Eriswil'                             ,NULL                                               ,'Zürich'                    ,'Gesellschafter und Geschäftsführer'         , 'mit Kollektivunterschrift zu zweien'                 , 'mit einem Stammanteil von CHF 10\'000.00'             , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2008-09-08'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Rüschlikon'                ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              , 'mit 200 Stammanteilen zu je CHF 100.00'               , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2008-09-08'  ,'+'  ,'Weber'         ,'Melanie'          ,'Gränichen'                           ,NULL                                               ,'Zell ZH'                   , null                                        , 'mit Einzelprokura'                                   ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-01-28'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Mettmenstetten'            ,'Präsident des Verwaltungsrates'             , 'mit Einzelunterschrift'                              ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-01-28'  ,'+'  ,'Kuhn'          ,'Roland'           ,'Illnau-Effretikon'                   ,NULL                                               ,'St. Gallen'                ,'Mitglied des Verwaltungsrates'              , 'mit Einzelunterschrift'                              ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth,  76284   ,'2009-10-26'  ,'-'  , null           , null              , null                                 ,'Fiduciaire Jean-Maurice Maitre S.A.'              ,'Porrentruy'                , null                                        ,  null                                                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth,  76284   ,'2009-10-26'  ,'+'  , null           , null              , null                                 ,'RéviAjoie Sàrl'                                   ,'Porrentruy'                , null                                        ,  null                                                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-11-06'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Mettmenstetten'            ,'Präsident des Verwaltungsrates'             , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-11-06'  ,'+'  ,'Kuhn'          ,'Roland'           ,'Illnau-Effretikon'                   ,NULL                                               ,'St. Gallen'                ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-11-06'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                               ,'Freienbach'                ,'Mitglied der Geschäftsleitung'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-11-06'  ,'+'  ,'Keller'        ,'Primin'           ,'Altendorf'                           ,NULL                                               ,'Waldkirch'                 ,'Mitglied der Geschäftsleitung'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2009-11-06'  ,'+'  ,'Weber'         ,'Melanie'          ,'Gränichen'                           ,NULL                                               ,'Zell ZH'                   , null                                        , 'mit Einzelprokura'                                   ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2009-12-03'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Mettmenstetten'            ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              , 'mit 170 Stammanteilen zu je CHF 100.00'               , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2009-12-03'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                               ,'Freienbach'                , null                                        , 'mit Kollektivunterschrift zu zweien'                 , 'mit 30 Stammanteilen zu je CHF 100.00'                , 0  ,0  ,0);
  cmp_person_firma($sth, 251792   ,'2010-07-07'  ,'-'  ,'Riedmüller'    ,'Josef'            ,'deutscher Staatsangehöriger'         ,NULL                                               ,'Biberach an der Riss (D)'  ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 251792   ,'2010-07-07'  ,'-'  ,'Wüst'          ,'Günter'           ,'Oberriet SG'                         ,NULL                                               ,'Lüchingen (Altstätten)'    ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2011-10-27'  ,'+'  ,'Hefti'         ,'Simon'            ,'Thun'                                ,NULL                                               ,'Zürich'                    ,'Präsident des Verwaltungsrates'             , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2011-10-27'  ,'+'  ,'Hagger'        ,'Joachim Andreas'  ,'Basel'                               ,NULL                                               ,'Zürich'                    ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2011-10-27'  ,'+'  ,'Vckovski'      ,'Andrej'           ,'Zürich'                              ,NULL                                               ,'Zürich'                    ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2011-10-27'  ,'+'  ,'Gränicher'     ,'Hans Peter'       ,'Röthenbach bei Herzogenbuchsee'      ,NULL                                               ,'Zürich'                    ,'Geschäftsführer'                            , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2012-12-05'  ,'+'  ,'Brabec'        ,'Dr. Bernhard'     ,'österreichischer Staatsangehöriger'  ,NULL                                               ,'Zollikon'                  , null                                        , 'mit Kollektivprokura zu zweien'                      ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2012-12-05'  ,'+'  ,'Rutz'          ,'Candid'           ,'Emmen'                               ,NULL                                               ,'Zürich'                    , null                                        , 'mit Kollektivprokura zu zweien'                      ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2012-12-05'  ,'+'  ,'Hausmann'      ,'Alexander'        ,'Dietikon'                            ,NULL                                               ,'Dietikon'                  , null                                        , 'mit Kollektivprokura zu zweien'                      ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2012-12-05'  ,'+'  ,'Stefanakos'    ,'Stamatios'        ,'griechischer Staatsangehöriger'      ,NULL                                               ,'Zürich'                    , null                                        , 'mit Kollektivprokura zu zweien'                      ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2013-07-29'  ,'-'  ,'Brabec'        ,'Dr. Bernhard'     ,'österreichischer Staatsangehöriger'  ,NULL                                               ,'Zollikon'                  , null                                        , 'mit Kollektivprokura zu zweien'                      ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2013-07-29'  ,'-'  ,'Hausmann'      ,'Alexander'        ,'Dietikon'                            ,NULL                                               ,'Dietikon'                  , null                                        , 'mit Kollektivprokura zu zweien'                      ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2013-07-29'  ,'+'  ,NULL            ,NULL               ,NULL                                  ,'ORTAG AG'                                         ,'Zürich'                    , null                                        ,  null                                                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2014-08-13'  ,'-'  ,'Hagger'        ,'Joachim Andreas'  ,'Basel'                               ,NULL                                               ,'Zürich'                    ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 823465   ,'2014-08-13'  ,'+'  ,'Franz'         ,'Mike'             ,'Frick'                               ,NULL                                               ,'Gipf-Oberfrick'            ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2016-10-04'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Mettmenstetten'            , null                                        , 'mit Einzelunterschrift'                              , 'mit 188 Stammanteilen zu je CHF 100.00'               , 0  ,0  ,0);
  cmp_person_firma($sth, 451407   ,'2016-10-04'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                               ,'Freienbach'                ,'Gesellschafter und Geschäftsführer'         , 'mit Einzelunterschrift'                              , 'mit 12 Stammanteilen zu je CHF 100.00'                , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2016-12-15'  ,'-'  ,'Kuhn'          ,'Roland'           ,'Illnau-Effretikon'                   ,NULL                                               ,'St. Gallen'                ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2016-12-15'  ,'-'  ,'Keller'        ,'Primin'           ,'Altendorf'                           ,NULL                                               ,'Waldkirch'                 ,'Mitglied der Geschäftsleitung'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 934296   ,'2016-12-15'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                               ,'Freienbach'                ,'Mitglied des Verwaltungsrates'              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  ...
  cmp_person_firma($sth, 74461    ,'2016-12-28'  ,'-'  , null           , null              , null                                 ,'Fidea SA'                                         ,'Chiasso'                   , null                                        ,  null                                                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'-'  ,'Martin-Metzger','Caroline'         ,'Pratteln und Möhlin'                 ,null                                               ,'Uster'                     , null                                        , 'ohne Zeichnungsberechtigung'                         ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'-'  ,'Schmid'        ,'Thomas'           ,'Kaiseraugst'                         ,null                                               ,'Sarnen'                    ,'Vizepräsident'                              , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'-'  ,'Jebelean'      ,'Ioan'             ,'Luzern'                              ,null                                               ,'Luzern'                    ,'Mitglied'                                   , 'ohne Zeichnungsberechtigung'                         ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'-'  ,'Vogel'         ,'Andres'           ,'Oberurnen'                           ,null                                               ,'Allschwil'                 ,'Mitglied'                                   , 'ohne Zeichnungsberechtigung'                         ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'+'  ,'Hostettler'    ,'Martin'           ,'Schwarzenburg'                       ,null                                               ,'Gerlafingen'               ,'Mitglied der Verwaltung'                    , 'mit Kollektivunterschrift zu zweien'                 ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'+'  ,'Simpson'       ,'Lars'             ,'Schönenwerd'                         ,null                                               ,'Zürich'                    ,'Mitglied der Verwaltung'                    , 'ohne Zeichnungsberechtigung'                         ,  null                                                  , 0  ,0  ,0);
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'+'  , null           , null              , null                                 ,'Solidis Treuhand AG (<M>CHE107.909.432<E>)'       ,'Olten'                     , null                                        ,  null                                                 ,  null                                                  , 0  ,0  ,0);
  ...
  cmp_person_firma($sth, 1290391  ,'2017-01-10'  ,'+'  ,'Grätzer'       ,'Adrian Willy'     ,'Einsiedeln'                          ,NULL                                               ,'Einsiedeln'                , null                                        , 'mit Kollektivunterschrift zu zweien'                 , 'mit 10 Stammanteilen zu je CHF 1\'000.00'             , 0  ,0  ,0); #_}

  echo "person_firma ok\n";

} #_}

function cmp_person_firma($sth, $id_firma, $dt_journal, $add_rm, $nachname, $vorname, $von, $bezeichnung, $in_,  #_{
  ...
  if (! eq($row[ 3], $nachname        )) {throw new Exception("cmp_person_firma 3 Nachname found: $row[3], expected: $nachname, id_firma=$id_firma, dt_journal=$dt_journal"); }
  if (! eq($row[ 4], $vorname         )) {throw new Exception("cmp_person_firma 4 Vorname found: $row[4], expected $vorname"); }
  if (! eq($row[ 5], $von             )) {throw new Exception("cmp_person_firma 5 von found: $row[5], expected $von"); }
  ...
  if (! eq($row[$c], $funktion        )) {throw new Exception("cmp_person_firma $c dt_journal=$dt_journal, id_firma=$id_firma, funktion=$revisionsstelle, row[c]="          . $row[$c]); } $c++;
  if (! eq($row[$c], $zeichnung       )) {throw new Exception("cmp_person_firma $c dt_journal=$dt_journal, id_firma=$id_firma, zeichnung expected:$zeichnung<     found: row[c]="         . $row[$c]); } $c++;
  ...
  if (! eq($row[$c], $gesellschafterin)) {throw new Exception("cmp_person_firma $c dt_journal=$dt_journal, id_firma=$id_firma, gesellschafterin=$gesellschafterin, row[c]=" . $row[$c]); } $c++;
  if (! eq($row[$c], $revisionsstelle )) {throw new Exception("cmp_person_firma $c dt_journal=$dt_journal, id_firma=$id_firma, revisionsstelle=$revisionsstelle, row[c]="   . $row[$c]); } $c++;
  if (! eq($row[$c], $liquidatorin    )) {throw new Exception("cmp_person_firma $c dt_journal=$dt_journal, id_firma=$id_firma, liquidatorin=$liquidatorin"); } $c++;

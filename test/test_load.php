...
function check_firma($dbh) { #_{
  ...
  $biomedac = 'International Academy for Biomedical and Drug Research, Biomedac en liquidation';
  ...
  cmp_firma($sth,  279826, 'Stiftung für Konsumentenschutz'                , 'CH03570159990',    null,   351,    null,  null,  2, null         , 3041575,''                                   ,'Monbijoustrasse'          , '61'  ,''                ,     null, '3007', 'Bern'             , 7);
  ...
  cmp_firma($sth,  467455, 'EQUAM Stiftung'                                , 'CH02070006954',    null,   261,    null,  null,  2, null         , 2679977,'c/o Niklaus Lüchinger'              ,'Grossmünsterplatz'        ,  '8'  ,''                ,     null, '8001', 'Zürich'           , 7);
...
function check_firma_bez($dbh) { #_{
  ...
  cmp_firma_bez($sth,  270248, '940', 1, 'DE',  3, 'Dr. Hans Duttweiler-Hug-Stiftung'                                          , '1996-01-01', '9999-12-31');
  ...
  cmp_firma_bez($sth,  279826, '940', 1, 'DE',  3, 'Stiftung für Konsumentenschutz'                                            , '1999-12-04', '9999-12-31');
  cmp_firma_bez($sth,  279826, '940', 2, 'FR',  3, 'Fondation pour la protection des consommateurs'                            , '1999-12-04', '9999-12-31');
  cmp_firma_bez($sth,  279826, '940', 2, 'IT',  3, 'Fondazione per la protezione dei consumatori'                              , '1999-12-04', '9999-12-31');
  ...
  cmp_firma_bez($sth,  467455, '940', 1, 'DE',  3, 'EQUAM Stiftung'                                                            , '1996-01-01', '9999-12-31');
  ...
  cmp_firma_bez($sth,  959835, '990', 1, 'DE',  3, 'Stiftung Bärenpark Bern'                                                   , '2009-10-26', '9999-12-31');
...
function check_zweck($dbh) { #_{
  ...
  cmp_zweck($sth,  270248, 'Einmalige oder periodische Unterstützung gemeinnütziger Institutionen oder Einzelpersonen sowie Aussetzung eines Musikpreises für Studierende am Konservatorium und an der Musikakademie in Zürich, alles nach Massgabe näherer Bestimmungen der Stiftungsurkunde.');
  ...
  cmp_zweck($sth,  279826, 'Wahrung der Interessen der Konsumenten, insbesondere Schutz der Konsumenten vor Benachteiligung usw.');
  ...
  cmp_zweck($sth,  467455, 'Förderung der externen, unabhängigen Qualitätssicherung und -kontrolle in der medizinischen Versorgung, insbesondere in Managed Care-Modellen und -Organisationen; soll zur Schlichtung von Konflikten zwischen Leistungsträgern und Patienten beitragen.');
...
function check_person_firma($dbh) { #_{
  ...
  $cnt=1;
    ...
    cmp_person_firma($sth,  $cnt++,  270248   , '2002-02-07'  , '-'  , 'Bleichenbacher'   , 'Rudolf'           , 'Zürich und Mörschwil'                , NULL                                        , 'Zürich'                    , 'provisorischer SR'                          ,'ohne Zeichnungsberechtigung'                           ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  270248   , '2002-02-07'  , '+'  , 'Schwarzmann'      , 'Dr. René'         , 'St. Gallen'                          , NULL                                        , 'Bubikon'                   , 'Mitglied und Sekretär'                      , $ku2                                                   ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  270248   , '2002-02-07'  , '+'  , 'Zehnder-Hessel'   , 'Gertrud Anna'     , 'Einsiedeln'                          , NULL                                        , 'Oberwil BL'                , 'Präsidentin'                                , $ku2                                                   ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  150042   , '2002-04-30'  , '+'  , 'Huber'            , 'Marcel'           , 'Eschenbach LU'                       , NULL                                        , 'Eschenbach LU'             , 'Kassier'                                    , $ku2                                                   ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  270248   , '2002-08-27'  , '+'  , 'Hug'              , 'Georges'          , 'Zuzwil SG und Zürich'                , null                                        , 'Cincinnati (Ohio, USA)'    , 'Mitglied'                                   , $ku2                                                   ,   null                                                  );
    ...
    cmp_person_firma($sth,  $cnt++,  738038   , '2004-02-20'  , '+'  , 'Grüring'          , 'Markus'           , 'Bern und Biel'                       ,  null                                       , 'Unterägeri'                , 'Verwaltungsratsmitglied'                    ,  $ku2                                                  ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  738038   , '2004-02-20'  , '+'  , 'Hodel'            , 'Peter'            , 'Willisau Land'                       ,  null                                       , 'Zug'                       , 'Verwaltungsratsmitglied'                    ,  $ku2                                                  ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  738038   , '2004-02-20'  , '+'  , 'Jud'              , 'Marcel'           , 'Benken (SG)'                         ,  null                                       , 'Vinelz'                    ,  null                                        ,  $kp2                                                  ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  738038   , '2004-02-20'  , '+'  , 'Triner'           , 'Werner'           , 'Schwyz und Zug'                      ,  null                                       , 'Zug'                       , 'Präsident'                                  ,  $eu                                                   ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  738038   , '2004-02-20'  , '+'  , 'Weiss'            , 'Triner Verena'    , 'Schwyz und Zug'                      ,  null                                       , 'Zug'                       ,  null                                        ,  $ep                                                   ,   null                                                  );
    ...
    cmp_person_firma($sth,  $cnt++,  718052   , '2012-02-23'  , '-'  , 'Held'             , 'Werner'           ,  null                                 , null                                        ,  null                       ,  null                                        , 'Einzelunterschrift'                                   ,   null                                                  );
    cmp_person_firma($sth,  $cnt++,  718052   , '2012-02-23'  , '-'  , 'Reutimann'        , 'Werner'           ,  null                                 , null                                        ,  null                       ,  null                                        , 'Einzelunterschrift'                                   ,   null                                                  );
...
function check_gemeinde($dbh) { #_{
  ...
  cmp_gemeinde($sth,  351, 'Bern'               );
  cmp_gemeinde($sth,  371, 'Biel/Bienne'        );
  cmp_gemeinde($sth, 1098, 'Ruswil'             );

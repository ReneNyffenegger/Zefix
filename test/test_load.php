...
function check_person_firma($dbh) { #_{
  ...
  check_count($dbh, 'person_firma', 61);
  ...
  cmp_person_firma($sth, $cnt++, 451407   ,'2005-07-04'  ,'-'  ,NULL            ,NULL               ,NULL                                  ,'Künzler Communications GmbH'                      ,'Bassersdorf'               , null                                        , 'ohne Zeichnungsberechtigung'                         , 'mit einer Stammeinlage von CHF 1\'000.--'             );
  ...
  cmp_person_firma($sth, $cnt++, 823465   ,'2005-12-22'  ,'+'  ,NULL            ,NULL               ,NULL                                  ,'Ortag, Organisations-, Revisions- und Treuhand-AG','Zürich'                    , null                                        ,  null                                                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 451407   ,'2009-12-03'  ,'+'  ,'Norgate'       ,'Thomas Aylwin'    ,'britischer Staatsangehöriger'        ,NULL                                               ,'Freienbach'                , null                                        , 'mit Kollektivunterschrift zu zweien'                 , 'mit 30 Stammanteilen zu je CHF 100.00'                );
  ...
  cmp_person_firma($sth, $cnt++, 823465   ,'2013-07-29'  ,'+'  ,NULL            ,NULL               ,NULL                                  ,'ORTAG AG'                                         ,'Zürich'                    , null                                        ,  null                                                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 451407   ,'2016-10-04'  ,'+'  ,'Ginnow'        ,'Richard'          ,'Volketswil'                          ,NULL                                               ,'Mettmenstetten'            , null                                        , 'mit Einzelunterschrift'                              , 'mit 188 Stammanteilen zu je CHF 100.00'               );
  ...
  cmp_person_firma($sth, $cnt++, 150042   ,'2016-12-29'  ,'-'  ,'Martin-Metzger','Caroline'         ,'Pratteln und Möhlin'                 ,null                                               ,'Uster'                     , null                                        , 'ohne Zeichnungsberechtigung'                         ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 150042   ,'2016-12-29'  ,'+'  , null           , null              , null                                 ,'Solidis Treuhand AG (<M>CHE107.909.432<E>)'       ,'Olten'                     , null                                        ,  null                                                 ,  null                                                  );
  ...
  cmp_person_firma($sth, $cnt++, 1290391  ,'2017-01-10'  ,'+'  ,'Grätzer'       ,'Adrian Willy'     ,'Einsiedeln'                          ,NULL                                               ,'Einsiedeln'                , null                                        , 'mit Kollektivunterschrift zu zweien'                 , 'mit 10 Stammanteilen zu je CHF 1\'000.00'             ); #_}
...
function cmp_person_firma($sth, $cnt, $id_firma, $dt_journal, $add_rm, $nachname, $vorname, $von, $bezeichnung, $in_,  #_{
  ...
  if (! eq($row[$c], $funktion        )) {throw new Exception("cmp_person_firma (cnt = $cnt) $c dt_journal=$dt_journal, id_firma=$id_firma, funktion=$revisionsstelle, row[c]="          . $row[$c]); } $c++;

...
function check_person_firma($dbh) { #_{
  ...
  cmp_person_firma($sth, 451407   ,'2005-07-04'  ,'-'  ,NULL            ,NULL               ,NULL                                  ,'Künzler Communications GmbH'                      ,'Bassersdorf'               , null                                        ,  null                                                 , 'CHF 1\'000.--'                                        , 1  ,0  ,0);
  ...
  cmp_person_firma($sth, 823465   ,'2005-12-22'  ,'+'  ,NULL            ,NULL               ,NULL                                  ,'Ortag, Organisations-, Revisions- und Treuhand-AG','Zürich'                    , null                                        ,  null                                                 ,  null                                                  , 0  ,1  ,0);
  ...
  cmp_person_firma($sth,  76284   ,'2009-10-26'  ,'-'  , null           , null              , null                                 ,'Fiduciaire Jean-Maurice Maitre S.A.'              ,'Porrentruy'                , null                                        ,  null                                                 ,  null                                                  , 0  ,1  ,0);
  cmp_person_firma($sth,  76284   ,'2009-10-26'  ,'+'  , null           , null              , null                                 ,'RéviAjoie Sàrl'                                   ,'Porrentruy'                , null                                        ,  null                                                 ,  null                                                  , 0  ,1  ,0);
  ...
  cmp_person_firma($sth, 823465   ,'2013-07-29'  ,'+'  ,NULL            ,NULL               ,NULL                                  ,'ORTAG AG'                                         ,'Zürich'                    , null                                        ,  null                                                 ,  null                                                  , 0  ,1  ,0);
  ...
  cmp_person_firma($sth, 150042   ,'2016-12-29'  ,'+'  , null           , null              , null                                 ,'Solidis Treuhand AG (<M>CHE107.909.432<E>)'       ,'Olten'                     , null                                        ,  null                                                 ,  null                                                  , 0  ,1  ,0);
...
function cmp_person_firma($sth, $id_firma, $dt_journal, $add_rm, $nachname, $vorname, $von, $bezeichnung, $in_,  #_{
  ...
  if (! eq($row[$c], $stammeinlage    )) {throw new Exception("cmp_person_firma $c dt_journal=$dt_journal, id_firma=$id_firma, Stammeinlage=$stammeinlage< row[c]="         . $row[$c]); } $c++;
